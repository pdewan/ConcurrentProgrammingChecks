...
public class AddOddNumberCallsSleep extends ClassCallsSleep {
	 public AddOddNumberCallsSleep() {			
		  super(ConcurrentOddNumbersSuite.ROOT_CLASS, "addOddNumber:int->void");	        
	  }	
}
