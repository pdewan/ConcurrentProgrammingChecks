...
public class CreateAndStartThreadsCallsSleep extends ClassCallsSleep {
	 public CreateAndStartThreadsCallsSleep() {			
		  super(ConcurrentOddNumbersSuite.ROOT_CLASS, "createAndStartThreads:->void");	        
	  }	
}
