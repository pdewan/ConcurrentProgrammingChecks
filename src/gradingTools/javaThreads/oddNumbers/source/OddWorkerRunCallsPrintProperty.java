...
public class OddWorkerRunCallsPrintProperty extends ClassCallsPrintProperty {
	public OddWorkerRunCallsPrintProperty() {
		super(ConcurrentOddNumbersSuite.WORKER_CLASS, "run:->void");
